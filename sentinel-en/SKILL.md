---
name: sentinel
description: An end-to-end engineer thinking OS for Claude Code. Uses 87 thinking habits (76 world-class + 11 security) across five phases (Plan, Build, Diagnose, Solve, Retro). Stops vibe coding's worst habits: surface looping, patching over alarms, symptom-not-root-cause fixes, security shortcuts. Triggers on coding, refactoring, bugs, tests, auth/data/keys, decisions. Keywords: sentinel, root cause, vibe coding, debug, security, injection, secrets, least privilege, thinking habits, root-cause tree.
---
