...
> 一個 Claude Code skill，扮演資深工程師的「思考層」——在你貼補丁、在淺層打轉、賭資安僥倖之前先喊停。讓AI在正式 coding**之前**就開始思考。三件式工具鏈的一環，配 [Cartographer](https://github.com/RayLi-Git/cartographer) 與 [Compass](https://github.com/RayLi-Git/compass)：**Cartographer 畫地圖 → Compass 照圖走 → Sentinel 站哨。**
...
| [Compass](https://github.com/RayLi-Git/compass) | 羅盤 | 照 PRD 蓋、不偏航、不漏項 |
| **Sentinel** | 哨兵 | 五階段全程思考把關、防資安僥倖 |
